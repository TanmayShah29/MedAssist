...
export default function RoadmapPage() {
  return (
    <div className="min-h-[100dvh] bg-[#FAFAF7] font-sans selection:bg-sky-200/60 flex flex-col">
      {/* Navbar */}
      <nav className="border-b border-[#E8E6DF] bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <BrandLockup showTagline />
          <Link href="/" className="text-[13px] font-semibold text-[#57534E] hover:text-[#1C1917] transition-colors flex items-center gap-1">
      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="font-display text-4xl sm:text-5xl text-[#1C1917] mb-6">
            The Future of MedAssist
          </h1>
          <p className="text-[17px] text-[#57534E] leading-relaxed max-w-2xl mx-auto">
        ...
        <section className="mb-20">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="font-display text-2xl text-[#1C1917]">Upcoming Enhancements</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Audio Summaries */}
            <div className="bg-white border border-[#E8E6DF] rounded-[16px] p-6 shadow-sm hover:border-violet-200 transition-colors group">
              ...
              <h3 className="text-[16px] font-bold text-[#1C1917] mb-2">Clinical Audio Summaries</h3>
            ...
            <div className="bg-white border border-[#E8E6DF] rounded-[16px] p-6 shadow-sm hover:border-violet-200 transition-colors group">
              ...
              <h3 className="text-[16px] font-bold text-[#1C1917] mb-2">Smart Specialist Search</h3>
              <p className="text-[14px] text-[#57534E] leading-relaxed">
            ...
            <div className="bg-white border border-[#E8E6DF] rounded-[16px] p-6 shadow-sm hover:border-violet-200 transition-colors group md:col-span-2">
              ...
              <h3 className="text-[16px] font-bold text-[#1C1917] mb-2">Apple Health & Oura Integrations</h3>
              <p className="text-[14px] text-[#57534E] leading-relaxed max-w-2xl">
        ...
        <section>
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="font-display text-2xl text-[#1C1917]">Monetization Strategy</h2>
          </div>

          <div className="bg-white border border-[#E8E6DF] rounded-[24px] overflow-hidden shadow-sm">
            <div className="p-8 border-b border-[#E8E6DF] bg-[#F5F4EF]">
              <h3 className="text-xl font-bold text-[#1C1917] mb-3">Why MedAssist will become a paid service</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    <Server className="w-4 h-4 text-[#78716C]" />
                    <h4 className="text-[14px] font-bold text-[#1C1917]">The Costs</h4>
                  </div>
                  <ul className="space-y-3">
                    <li className="text-[14px] text-[#57534E] flex items-start gap-2">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    <Sparkles className="w-4 h-4 text-[#78716C]" />
                    <h4 className="text-[14px] font-bold text-[#1C1917]">The Model</h4>
                  </div>
                  <ul className="space-y-3">
                    <li className="text-[14px] text-[#57534E] flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 mt-1.5 flex-shrink-0" />
                      <strong className="text-[#1C1917]">Free Tier:</strong> 1 free lab report analysis to experience the value and prepare for an urgent visit.
                    </li>
                    <li className="text-[14px] text-[#57534E] flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 mt-1.5 flex-shrink-0" />
                      <strong className="text-[#1C1917]">Pay-per-report:</strong> A low flat fee (e.g. $4.99) for one-off analyses.
                    </li>
                    <li className="text-[14px] text-[#57534E] flex items-start gap-2">
                      <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 mt-1.5 flex-shrink-0" />
                      <strong className="text-[#1C1917]">Pro Subscription:</strong> For users with chronic conditions needing continuous tracking and integrations.
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-sky-50 border-t border-[#E8E6DF] p-6 text-center">
      ...
      {/* Footer */}
      <footer className="border-t border-[#E8E6DF] bg-white py-10 px-6 text-center">
