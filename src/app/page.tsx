...
function HeroWorkflowScene() {
  return (
    <motion.div 
      ...
      className="pointer-events-none relative mx-auto mt-8 hidden w-full max-w-4xl lg:block"
    >
      ...
      <div className="relative grid grid-cols-3 gap-5">
        <motion.div 
          ...
          className="rounded-[16px] border border-sky-100 bg-white/90 p-4 shadow-xl shadow-stone-900/[0.04] backdrop-blur"
        >
        ...
        <motion.div 
          ...
          className="rounded-[16px] border border-violet-100 bg-white/92 p-4 shadow-xl shadow-stone-900/[0.05] backdrop-blur"
        >
          <div className="mb-3 flex items-center justify-between">
          ...
          <div className="space-y-2.5">
            <motion.span 
              ...
              className="block h-2 w-full rounded-full bg-violet-100 origin-left" 
            />
            <motion.span 
              initial={{ scaleX: 0 }}
              animate={{ scaleX: 1 }}
              transition={{ duration: 1.5, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 0.2 }}
              className="block h-2 w-4/5 rounded-full bg-violet-100 origin-left" 
            />
            <motion.span 
              initial={{ scaleX: 0 }}
              animate={{ scaleX: 1 }}
              transition={{ duration: 1.5, repeat: Infinity, repeatType: "reverse", ease: "easeInOut", delay: 0.4 }}
              className="block h-2 w-2/3 rounded-full bg-violet-100 origin-left" 
            />
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="rounded-[16px] border border-emerald-100 bg-white/90 p-4 shadow-xl shadow-stone-900/[0.04] backdrop-blur"
        >
          <div className="mb-3 flex items-center justify-between">
    ...
    <div ref={containerRef} className="min-h-[100dvh] bg-[#FAFAF7] font-sans">
      ...
      <section className="relative min-h-[100dvh] px-4 pb-10 pt-20 sm:px-6 sm:pt-24 overflow-hidden">
        ...
        <motion.div 
          ...
          className="relative mx-auto flex min-h-[calc(100dvh-7rem)] w-full max-w-6xl flex-col justify-center"
        >
          <motion.div 
            initial="hidden"
            animate="visible"
          ...
          >
            <motion.div variants={fadeInUp}>
              <Pill className="bg-white/86 border border-sky-200 text-sky-700 mb-5 shadow-sm">
            ...
            <motion.h1 variants={fadeInUp} className="font-display text-[42px] sm:text-6xl lg:text-[68px] xl:text-[74px] text-[#1C1917] leading-[0.98] mb-5 max-w-full text-balance">
              ...
              <span className="relative inline-block">
                ...
                <motion.span 
                  ...
                  className="absolute inset-x-0 -bottom-1 h-[3px] bg-gradient-to-r from-sky-300 via-sky-500 to-sky-300 rounded-full opacity-70 origin-left" 
                />
              </span>
            </motion.h1>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-3 mb-6 justify-center">
              <Link
                href="/demo"
            ...
            <motion.div variants={fadeInUp} className="grid grid-cols-1 gap-2 sm:flex sm:flex-wrap sm:gap-3 mt-5 justify-center">
              {[
          ...
          >
            {[
              ...
              <motion.div
                ...
                variants={fadeInUp}
                whileHover={{ y: -5 }}
                className={`relative bg-white border ${item.border} rounded-[20px] p-7 shadow-sm`}
              >
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="lg:col-span-4 relative overflow-hidden bg-gradient-to-br from-sky-50 via-white to-sky-50/30 border border-sky-100 rounded-[24px] p-8 shadow-sm group hover:-translate-y-1 transition-transform">
                ...
                <div className="space-y-2">
                  {["Key Findings", "Lab Trend", "Doctor Questions"].map((_, idx) => (
                    <div key={idx} className="flex items-center gap-2">
                      ...
                      <div className="flex-1 h-1.5 bg-sky-100 rounded-full animate-pulse" style={{ animationDelay: `${idx * 200}ms` }} />
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Trend Tracking */}
            <motion.div variants={fadeInUp} className="lg:col-span-2 relative overflow-hidden bg-gradient-to-br from-emerald-50 via-white to-emerald-50/30 border border-emerald-100 rounded-[24px] p-6 shadow-sm group hover:-translate-y-1 transition-transform">
            ...
            {/* AI Explanations */}
            <motion.div variants={fadeInUp} className="lg:col-span-2 relative overflow-hidden bg-gradient-to-br from-violet-50 via-white to-violet-50/30 border border-violet-100 rounded-[24px] p-6 shadow-sm group hover:-translate-y-1 transition-transform">
            ...
            {/* Streaming Assistant */}
            <motion.div variants={fadeInUp} className="lg:col-span-2 relative overflow-hidden bg-gradient-to-br from-amber-50 via-white to-amber-50/30 border border-amber-100 rounded-[24px] p-6 shadow-sm group hover:-translate-y-1 transition-transform">
            ...
            <motion.div variants={fadeInUp} className="lg:col-span-6 relative overflow-hidden bg-gradient-to-r from-indigo-50 via-white to-sky-50 border border-indigo-100 rounded-[24px] p-8 shadow-sm group hover:-translate-y-1 transition-transform">
            ...
            >
              ...
              <div className="space-y-7">
                {[
                  ...
                  <motion.div key={title} variants={fadeInUp} className="flex gap-4">
                ...
                <div className="relative z-10 space-y-4">
                  ...
                  >
                    {[
                      ...
                      <motion.div key={i} variants={fadeInUp} className="flex items-center gap-3 mb-4">
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { label: "Engineering Architecture", href: "/engineering" },
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { label: "About MedAssist", href: "/about" },
                  { label: "Roadmap & Pricing", href: "/roadmap" },
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-white/5">
            <p className="text-[12px] text-slate-600">
              © 2026 MedAssist · Built by <span className="text-slate-400 font-semibold">Tanmay Shah</span> for Design Engineering
            </p>
