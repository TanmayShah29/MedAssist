...
export function AnalysisPanel({ biomarkers, symptoms, doctorQuestions = [] }: AnalysisPanelProps) {
    ...
    return (
        <div className="h-full overflow-y-auto p-5 lg:p-6 space-y-8 bg-[#FFFFFF] min-w-0">
            {/* Detected Entities */}
            <div>
                <h3 className="text-[11px] uppercase tracking-widest text-[#64748B] font-semibold mb-3">Context Detected</h3>
                {entities.length > 0 ? (
                    ...
                    <p className="text-xs text-[#64748B] italic">No symptoms or discussion-focused labs found.</p>
                )}
            </div>

            {/* Evidence Trail */}
            <div className="pt-4 border-t border-[#EBEAE4]">
                <h3 className="text-[11px] uppercase tracking-widest text-[#64748B] font-semibold mb-3">Preparation Progress</h3>
            ...
            {doctorQuestions.length > 0 && (
                <div className="pt-4 border-t border-[#EBEAE4]">
                    <h3 className="text-[11px] uppercase tracking-widest text-[#64748B] font-semibold mb-3 flex items-center gap-2">
