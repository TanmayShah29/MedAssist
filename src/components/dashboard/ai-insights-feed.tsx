...
export function AIInsightsFeed({ analysis }: AIInsightsFeedProps) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 gap-6">
            {/* Main AI Summary */}
            <div className="bg-white rounded-[18px] p-6 border border-[#E8E6DF] shadow-sm hover:shadow-md hover:border-[#D9D6CD] hover:-translate-y-0.5 transition-all duration-300 ease-out md:col-span-2 2xl:col-span-2 min-w-0 group">
                ...
                <Link
                    href="/results"
                    className="flex items-center justify-center gap-2 w-full py-2.5 rounded-[10px] border border-[#E8E6DF] text-sm font-semibold text-[#57534E] hover:bg-[#F5F4EF] hover:text-[#1C1917] hover:border-[#D9D6CD] transition-all duration-200"
                >
                    Review lab details
            ...
            {/* CTA Card */}
            <div className="bg-[#1C1917] rounded-[18px] p-6 border border-[#2C2A27] shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 ease-out flex flex-col items-center text-center justify-center relative overflow-hidden min-w-0 group">
