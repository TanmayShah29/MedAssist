            ...
            <div className="flex items-center justify-between gap-3 mb-6">
                <div className="flex items-center gap-2 min-w-0">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-[12px] text-[#64748B] truncate">Track medications & supplements for your clinician</p>
                    </div>
                </div>
                <button
                ...
                {showAddForm && (
                    ...
                    >
                        <div className="grid grid-cols-1 gap-3">
                            <div>
                                <label className="text-[11px] font-bold text-[#64748B] uppercase mb-1 block">Medication or Supplement</label>
                                <input
                                    type="text"
                                    required
                                    value={newSupp.name}
                            ...
                            <div>
                                <label className="text-[11px] font-bold text-[#64748B] uppercase mb-1 block">Dosage</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="text-[11px] font-bold text-[#64748B] uppercase mb-1 block">Start Date</label>
                                <input
                                    type="date"
                                    required
            ...
            <div className="space-y-3">
                {loading ? (
                    ...
                    supplements.map((supp, idx) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="p-2 text-[#64748B] hover:text-rose-600 hover:bg-rose-50 active:scale-90 rounded-lg transition-all duration-200 opacity-0 group-hover:opacity-100 shrink-0"
                    ...
                    <div className="py-8 text-center bg-slate-50/50 rounded-xl border border-dashed border-[#EBEAE4]">
                        <p className="text-[12px] text-[#64748B]">No medications or supplements logged yet.</p>
                    </div>
                )}
            </div>
