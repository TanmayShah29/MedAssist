...
export function DoctorVisitPrep({
    ...
    return (
        <section id="doctor-prep-sheet" className={cn("bg-white border border-sky-100 rounded-[18px] p-5 md:p-6 shadow-sm", className)}>
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-5">
                ...
                <div className="flex gap-2 print:hidden">
                    <button
                        onClick={copyPrep}
                        className="inline-flex items-center justify-center gap-1.5 rounded-[10px] border border-[#E8E6DF] bg-white px-3 py-2 text-[12px] font-semibold text-[#57534E] hover:border-sky-300 hover:text-sky-600 min-h-[40px]"
                    >
                    ...
                    <button
                        ...
                        className="inline-flex items-center justify-center gap-1.5 rounded-[10px] bg-sky-500 px-3 py-2 text-[12px] font-semibold text-white hover:bg-sky-600 min-h-[40px]"
                    >
                ...
                <div className="rounded-[14px] border border-[#E8E6DF] bg-[#FAFAF7] p-4">
                    ...
                    <div className="space-y-2">
                        {prep.flagged.length > 0 ? prep.flagged.map(b => (
                            ...
                            <p className="text-[13px] text-[#A8A29E]">No flagged biomarkers in the latest report.</p>
                        )}
                    </div>
                </div>

                <div className="rounded-[14px] border border-[#E8E6DF] bg-[#FAFAF7] p-4">
                    <h3 className="text-[11px] font-bold uppercase tracking-wider text-[#A8A29E] mb-3">What changed</h3>
                    <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 gap-4 mt-4 xl:grid-cols-2">
                <div className="rounded-[14px] border border-[#E8E6DF] bg-[#FAFAF7] p-4">
                    <h3 className="text-[11px] font-bold uppercase tracking-wider text-[#A8A29E] mb-3">Ask your doctor</h3>
                ...
                <div className="rounded-[14px] border border-[#E8E6DF] bg-[#FAFAF7] p-4">
                    <h3 className="text-[11px] font-bold uppercase tracking-wider text-[#A8A29E] mb-3">Bring with you</h3>
